...
final readonly class CatalogAPIResponse implements CatalogAPIInterface
{
    ...
    private function buildGoodResponse(Good $good): CatalogGoodResponse
    {
    ...
    private function buildManufacturerComponent(Good $good): ?ManufacturerComponent
    {
    ...
    private function buildGroupComponent(Good $good): CatalogGroupComponent
    {
        $group = $good->getGroup();
